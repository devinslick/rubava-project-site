...
class InvolvementsControllerTest < ActionController::TestCase
  ...
  test "should create involvement" do
    assert_difference('Involvement.count') do
      post :create, involvement: { contributions: @involvement.contributions, member_id: @involvement.member_id, project_id: @involvement.project_id, role: @involvement.role }
    end
  ...
  test "should update involvement" do
    put :update, id: @involvement, involvement: { contributions: @involvement.contributions, member_id: @involvement.member_id, project_id: @involvement.project_id, role: @involvement.role }
    assert_redirected_to involvement_path(assigns(:involvement))
  end
